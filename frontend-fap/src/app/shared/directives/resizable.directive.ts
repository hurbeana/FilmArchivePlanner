import {Directive, ElementRef, OnInit, Input, ViewChild, AfterViewInit, Renderer2} from '@angular/core';
...
export class ResizableDirective implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.tableContainer = this.el.nativeElement.querySelector('.table-container');
    this.detailsContainer = this.el.nativeElement.querySelector('.details-container');
    this.dragBar = this.el.nativeElement.querySelector('.table-container #dragbar');
